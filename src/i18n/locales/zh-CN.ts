...
export default {
  ...
  "home": {
    ...
    "gridQueryMode": "查询",
    "gridQueryExactPath": "精确路径",
    "gridQuerySubtree": "目录子树",
    "gridQueryExit": "退出查询模式并返回基础搜索",
    "gridQueryPlaceholder": "输入 path 或 under 查询路径...",
    "gridQueryExactPathPlaceholder": "输入精确文件夹路径...",
    "gridQuerySubtreePlaceholder": "输入父目录路径...",
    "gridQueryPending": "未应用",
    "gridQueryApplied": "已应用",
    "gridQueryApply": "应用",
    "gridQueryPathHint": "精确匹配一个文件夹路径",
    "gridQueryUnderHint": "匹配文件夹及其全部后代",
    "gridQueryPathSuggestion": "本地文件夹路径",
    "gridQueryUnterminatedQuote": "路径引号尚未闭合",
    "gridQueryMissingArgument": "path 或 under 后需要填写路径",
    "gridFolderSelectionSummary": "已选 {{selected}}/{{total}} 个文件夹 · {{tracks}} 首歌曲",
    "gridFolderSelectAll": "全选",
    "gridFolderSelectNone": "全不选",
    "gridFolderShowTree": "打开目录树",
    "gridFolderHideTree": "关闭目录树",
    ...
    "gridFolderDirectoryTree": "目录树",
    "gridFolderExpandTreePanel": "展开",
    "gridFolderCollapseTreePanel": "收起",
    "gridFolderExactPath": "暂存精确路径查询",
    "gridFolderSubtreePath": "暂存目录子树查询",
