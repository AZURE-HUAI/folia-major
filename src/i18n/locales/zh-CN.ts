...
export default {
  ...
  "commandPalette": {
    ...
    "sleepTimerTitle": "定时关闭",
    "sleepTimerEnabledHint": "应用将在 {{hours}} 小时 {{minutes}} 分钟后关闭",
    "sleepTimerZeroHint": "0 小时 0 分钟不会关闭应用，请选择时长",
    "sleepTimerDisabledHint": "开启后即可设定自动关闭",
    ...
    "commands": {
      ...
      "sleep-timer": { "title": "定时关闭", "description": "在指定时长后自动关闭应用" },
