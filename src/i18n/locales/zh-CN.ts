...
export default {
  ...
  "options": {
    ...
    "transitionEnable": "换歌时做过渡",
    "transitionEnableDesc": "让上一首的结尾和下一首的开头叠在一起，而不是停下来再开始。音量条末尾的混音图标是同一个开关。",
    "transitionMode": "过渡模式",
    "transitionModeDesc": "两套彼此独立的策略，同一时间只有一套在跑。",
    "transitionCrossfade": "Folia Crossfade",
    "transitionCrossfadeDesc": "一条等功率交叉淡化，长度由你设定，每次形状都一样。任何歌都能用，不需要分析。",
    "transitionAutomix": "Folia Automix",
    "transitionAutomixDesc": "分析两首歌的速度、调性、段落边界、响度、唱到哪里结束，自己决定这次要不要接、从哪里开始接、用哪种接法、接多长。",
    "transitionActive": "使用中",
    "transitionFellBack": "已退回淡化",
    "crossfadeMaxSeconds": "过渡最长时长",
    "crossfadeMaxSecondsDesc": "这是上限不是定值：只要两首歌之间还留得下这么多空间，每次换歌就用这么长。",
    "crossfadeSecondsValue": "{{seconds}} 秒",
    "transitionAutomixLength": "长度每次换歌单独算，上限 {{seconds}} 秒。这里没有滑轨是故意的——决定长度正是这个模式在做的事。",
    "transitionAutomixUnavailable": "当前环境无法解码音频做分析，Automix 不可用；换歌会退回稳定的交叉淡化。",
    "transitionEngineFull": "完全体",
    "transitionEngineFullDesc": "客户端：小节线来自节拍模型，两首歌会被拆成人声/鼓/贝斯/其余四轨，逐件乐器交接。",
    "transitionEngineLite": "兼容模式",
    "transitionEngineLiteDesc": "浏览器端：判断逻辑完全一样，只是改用内置分析。拆轨与节拍模型需要客户端。",
    ...
    "developerSettingsDesc": "应用运行时记下的日志。",
    "consoleLogCapture": "运行日志",
    "consoleLogCaptureDesc": "记录应用运行时打出的日志，出问题时可以回看和复制交出去。打包后的桌面版本身没有控制台。",
    "consoleLogCaptureOff": "未在记录。本次运行的日志无法回看，也无法复制。",
    "consoleLogConvention": "日志按开头的 [模块] 前缀分组，用 console.log('[你的模块] …') 打出来的行就能单独筛选。详见 docs/client-logging.md。",
