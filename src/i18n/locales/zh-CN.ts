...
export default {
  ...
  "options": {
    ...
    "transitionEnable": "过渡",
    "transitionEnableDesc": "上一首还没完，下一首就开始。音量条旁的图标是同一个开关。",
    "transitionMode": "过渡模式",
    "transitionModeDesc": "同一时间只有一套在跑。",
    "transitionCrossfade": "Folia Crossfade",
    "transitionCrossfadeDesc": "固定的淡出淡入，长度你定，每次都一样。任何歌都能用。",
    "transitionAutomix": "Folia Automix",
    "transitionAutomixDesc": "先听懂两首歌，再决定这次接不接、从哪接、怎么接、接多长。",
    ...
    "transitionAutomixLength": "长度每次单独算，上限 {{seconds}} 秒。没有滑轨是故意的——长度归它决定。",
    ...
    "consoleLogCaptureDesc": "记下应用运行时的日志，出问题时能回看、能复制交出去。",
