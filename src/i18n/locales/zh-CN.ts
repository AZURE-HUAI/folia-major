...
export default {
  ...
  "commandPalette": {
    ...
    "commands": {
      ...
      "visualizer-tempera": { "title": "切换到可视化：蛋彩", "description": "切换到蛋彩色块 PV 可视化" },
  ...
  "options": {
    ...
    "sonnetToggleOn": "开启",
    "sonnetToggleOff": "关闭",
    "temperaSettings": "蛋彩参数",
    "temperaSettingsDesc": "调整蛋彩的色块构图、镜头运动与渲染质量。建议搭配空 / Sora 背景。",
    "temperaMotionSection": "动态与调色",
    "temperaDisplaySection": "显示内容",
    "temperaQualitySection": "渲染质量",
    "temperaFontSizeAutoNotice": "蛋彩模式会根据画面尺寸、歌词量和排版区域自动计算字号；通用字体尺寸设置在此模式下无效。",
