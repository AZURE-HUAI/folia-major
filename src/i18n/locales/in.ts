export default {
  ...
  "home": {
    ...
    "gridQueryMode": "Kueri",
    "gridQueryExactPath": "Jalur tepat",
    "gridQuerySubtree": "Subpohon folder",
    "gridQueryExit": "Keluar dari mode kueri dan kembali ke pencarian dasar",
    "gridQueryPlaceholder": "Masukkan path atau under untuk memfilter folder...",
    "gridQueryExactPathPlaceholder": "Masukkan jalur folder yang tepat...",
    "gridQuerySubtreePlaceholder": "Masukkan jalur folder induk...",
    "gridQueryPending": "Belum diterapkan",
    "gridQueryApplied": "Diterapkan",
    "gridQueryApply": "Terapkan",
    "gridQueryPathHint": "Cocokkan satu jalur folder secara tepat",
    "gridQueryUnderHint": "Cocokkan folder dan semua turunannya",
    "gridQueryPathSuggestion": "Jalur folder lokal",
    "gridQueryUnterminatedQuote": "Tanda kutip jalur belum ditutup",
    "gridQueryMissingArgument": "path dan under memerlukan jalur folder",
    ...
    "gridFolderShowTree": "Buka pohon direktori",
    "gridFolderHideTree": "Tutup pohon direktori",
    ...
    "gridFolderDirectoryTree": "Pohon direktori",
    "gridFolderExpandTreePanel": "Perluas",
    "gridFolderCollapseTreePanel": "Ciutkan",
    "gridFolderExactPath": "Siapkan kueri jalur tepat",
    "gridFolderSubtreePath": "Siapkan kueri subpohon",
