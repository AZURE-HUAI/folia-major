...
export default {
  ...
  "commandPalette": {
    ...
    "sleepTimerEnabledHint": "App will close after {{hours}}h {{minutes}}m",
    "sleepTimerZeroHint": "0h 0m never closes the app; pick a duration above",
    "sleepTimerDisabledHint": "Turn it on to schedule an auto close",
    ...
    "commands": {
      ...
      "sleep-timer": { "title": "Sleep timer", "description": "Close the app after a chosen duration" },
