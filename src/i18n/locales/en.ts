...
export default {
  ...
  "options": {
    ...
    "transitionEnable": "Blend song changes",
    "transitionEnableDesc": "Overlap the end of one track with the start of the next instead of stopping and starting. Also on the Blend icon at the end of the volume row.",
    "transitionMode": "Transition mode",
    "transitionModeDesc": "Two separate strategies. Only one runs at a time.",
    "transitionCrossfade": "Folia Crossfade",
    "transitionCrossfadeDesc": "One equal-power crossfade, the length you set, in the same shape every time. Works on any track and needs no analysis.",
    "transitionAutomix": "Folia Automix",
    "transitionAutomixDesc": "Analyses both tracks - tempo, key, section edges, loudness, where the singing stops - and decides for itself whether to blend, when to start, which shape to use and how long.",
    "transitionActive": "Active",
    "transitionFellBack": "Using crossfade",
    "crossfadeMaxSeconds": "Maximum transition length",
    "crossfadeMaxSecondsDesc": "A ceiling, not a fixed length: a song change gets this much unless the two tracks have less room than that between them.",
    "crossfadeSecondsValue": "{{seconds}}s",
    "transitionAutomixLength": "Length is chosen per song change, up to {{seconds}}s. There is no slider here on purpose - picking it is what this mode does.",
    ...
    "transitionEngineFullDesc": "Desktop build: bar lines come from the beat model, and each track is separated so the two are handed over instrument by instrument.",
    "transitionEngineLite": "Compatible",
    "transitionEngineLiteDesc": "Browser build: the same decisions, measured with the built-in analysis. Separation and the beat model need the desktop app.",
