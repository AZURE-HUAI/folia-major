...
export default {
  ...
  "options": {
    ...
    "transitionEnableDesc": "Start the next track before this one ends. Same switch as the icon by the volume row.",
    "transitionMode": "Transition mode",
    "transitionModeDesc": "Only one runs at a time.",
    "transitionCrossfade": "Folia Crossfade",
    "transitionCrossfadeDesc": "One fade out into one fade in, the length you set, the same every time. Works on any track.",
    "transitionAutomix": "Folia Automix",
    "transitionAutomixDesc": "Listens to both tracks first, then decides whether to blend, where, how and for how long.",
    ...
    "transitionAutomixLength": "Length is picked per song change, up to {{seconds}}s. No slider on purpose - the length is its call.",
    ...
    "consoleLogCaptureDesc": "Keep what the app logs while it runs, so a problem can be read back and handed over.",
