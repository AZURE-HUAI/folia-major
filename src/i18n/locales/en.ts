...
export default {
  ...
  "home": {
    ...
    "gridQueryMode": "Query",
    "gridQueryExactPath": "Exact path",
    "gridQuerySubtree": "Folder subtree",
    "gridQueryExit": "Exit query mode and return to basic search",
    "gridQueryPlaceholder": "Enter path or under to filter folders...",
    "gridQueryExactPathPlaceholder": "Enter an exact folder path...",
    "gridQuerySubtreePlaceholder": "Enter a parent folder path...",
    "gridQueryPending": "Not applied",
    "gridQueryApplied": "Applied",
    "gridQueryApply": "Apply",
    "gridQueryPathHint": "Match one exact folder path",
    "gridQueryUnderHint": "Match a folder and all descendants",
    "gridQueryPathSuggestion": "Local folder path",
    "gridQueryUnterminatedQuote": "The path quote is not closed",
    "gridQueryMissingArgument": "path and under require a folder path",
    ...
    "gridFolderShowTree": "Open directory tree",
    "gridFolderHideTree": "Close directory tree",
    ...
    "gridFolderDirectoryTree": "Directory tree",
    "gridFolderExpandTreePanel": "Expand",
    "gridFolderCollapseTreePanel": "Collapse",
    "gridFolderExactPath": "Stage exact-path query",
    "gridFolderSubtreePath": "Stage subtree query",
