...
const ModeStepperRow = <Value extends string>({
    ...
    const renderStepButton = (direction: -1 | 1) => (
        <button
            ...
            disabled={!canStep}
            className={`flex h-8 w-6 shrink-0 items-center justify-center rounded-lg opacity-40 transition-all ${hoverBg} hover:opacity-100 disabled:cursor-not-allowed disabled:opacity-20`}
    ...
    return (
        <div className="flex items-center gap-0.5">
            ...
            <div className="flex min-w-[1.75rem] shrink-0 items-center justify-end gap-0.5">
                {trailing}
            </div>
